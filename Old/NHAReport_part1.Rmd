...
```{r setup, include=FALSE, cache.lazy=T}
...
```{r species table, echo=FALSE, cache.lazy=T}
...
```{r select Biotics EO Records, echo=FALSE, cache.lazy=T}
...
```{r print Biotics info, echo=FALSE, cache.lazy=T}
...
``` {r EO Threats Database, echo=FALSE, cache.lazy=T}
...
```{r References, echo=FALSE, cache.lazy=T}
...
* Photo file name: *enter name of photo file uploaded to folder here.* 
