...
Site significance rank: |SIG_B| **`r paste(as.character(selected_nha$SIG_RANK))`**  |SIG_E|   

NHA Join ID: |JOIN_B| **`r paste(as.character(selected_nha$NHA_JOIN_ID))`** |JOIN_E|   
...
**Acreage:** `r round(selected_nha$Acres, -1)` acres
