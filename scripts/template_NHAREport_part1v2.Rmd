...
Sel_TR <- inner_join(ELCODE_sub, ELCODE_TR, copy=TRUE) %>%
  select(SNAME, CategoryName, Threats, Recs, Citation_Full) %>% collect()
...
Sel_Citations <- inner_join(ELCODE_sub, Sel_TR, copy=TRUE) %>%
