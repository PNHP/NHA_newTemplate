...
Site significance rank: **`r paste(as.character(selected_nha$site_rank))`**  
...
The brief description from the NHA geodatabase for this site reads: **`r selected_nha[7]$BRIEF_DESC`** 

The following old NHA sites overlap with the current NHA: `r selected_nha$OLD_SITE_NAME`
